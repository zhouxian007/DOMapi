...
})({"hTMSR":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
window.dom = {
    ...
    text (node, string) {
        if (arguments.length === 2) {
            ...
            ;
            else node.textContent = string //firefox或者chrome
            ;
    ...
    html (node, string) {
        ...
        else if (arguments.length === 1) return node.innerHTML = string;
    },
